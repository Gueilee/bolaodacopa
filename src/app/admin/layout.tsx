  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: '#f0ede8' }}>
      ...
      >
        ...
        {/* Badge modo admin/rh — compacto */}
        <div style={{
          margin: '10px 12px',
          padding: '8px 12px',
          borderRadius: 10,
          background: isAdmin ? 'rgba(255,47,105,0.1)' : 'rgba(1,225,142,0.07)',
          border: `1px solid ${isAdmin ? 'rgba(255,47,105,0.2)' : 'rgba(1,225,142,0.15)'}`,
          ...
          <p style={{
            ...
            {isAdmin ? 'Modo Administrador' : 'Modo RH'}
          </p>
        </div>
